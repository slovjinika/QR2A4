...
def create_sticker(text, font_path):
    """Creates a single compact sticker without empty margins and rotates it 90 degrees"""
...
for idx, text in enumerate(data_list):
    ...
    # Використовуємо нові розміри повернутого стікера для розрахунку сітки
    group_w_mm = (ROTATED_STICKER_W_MM * 2) + GAP_X_MM
